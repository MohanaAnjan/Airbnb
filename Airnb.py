...
st.set_page_config(page_title= "Airbnb Data Visualization | By MOHANA ANJAN",
                   layout= "wide",
...
client = pymongo.MongoClient("mongodb+srv://Anjan:rootroot1234@anjan.2lwipxc.mongodb.net/?retryWrites=true&w=majority&appName=Anjan")
